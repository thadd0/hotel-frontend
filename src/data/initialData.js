export const initialData = {
  ...
  empresa: {
    ...
    ruc: '20123456789',
    direccion: 'Av. Principal 123, Centro, Lima',
    telefono: '+51 1 234 5678',
    email: 'info@hotelcentral.pe',
    visible: true
  },
  
  // TIPOS ALQUILER (Nueva)
  tiposAlquiler: [
    { id: 1, nombre: 'POR HORA', multiplier: 0.04, visible: true },
    { id: 2, nombre: 'POR DIA', multiplier: 1, visible: true },
    { id: 3, nombre: 'POR NOCHE', multiplier: 0.8, visible: true },
  ],
  
  // TIPOS HABITACION (Nueva - expandir categorias)
  tiposHabitacion: [
    { id: 1, nombre: 'SIMPLE', capacidad: 1, visible: true },
    { id: 2, nombre: 'DOBLE', capacidad: 2, visible: true },
    { id: 3, nombre: 'MATRIMONIAL', capacidad: 2, visible: true },
    { id: 4, nombre: 'FAMILIAR', capacidad: 4, visible: true },
  ],
  ...
  habitaciones: [  // 18 rooms SIMPLE/DOBLE across 3 pisos
    ...
    { id: 2,  numero: '102', categoriaId: 1, ubicacionId: 1, tarifaIds: [1], estado: 'OCUPADO',    visible: true, persons: [{id:1,nombre:'Juan Pérez',telefono:'+51-1-1234',tipoDocumento:'DNI',documento:'30123456'}], checkIn:{tarifaId:1,tarifaValue:50,nights:2,startDate:'2024-10-10',endDate:'2024-10-12',total:100} },
    ...
    { id: 5,  numero: '105', categoriaId: 2, ubicacionId: 1, tarifaIds: [2], estado: 'OCUPADO',    visible: true, persons: [{id:2,nombre:'Ana García',telefono:'+51-1-5678',tipoDocumento:'DNI',documento:'25123456'}], checkIn:{tarifaId:2,tarifaValue:80,nights:3,startDate:'2024-10-09',endDate:'2024-10-12',total:240} },
    ...
    { id: 10, numero: '204', categoriaId: 2, ubicacionId: 2, tarifaIds: [2], estado: 'OCUPADO',    visible: true, persons: [{id:3,nombre:'Luis Rodríguez',telefono:'+51-1-9012',tipoDocumento:'DNI',documento:'33123456'}], checkIn:{tarifaId:2,tarifaValue:80,nights:1,startDate:'2024-10-11',endDate:'2024-10-12',total:80} },
    ...
    { id: 15, numero: '304', categoriaId: 2, ubicacionId: 3, tarifaIds: [2], estado: 'OCUPADO',    visible: true, persons: [{id:4,nombre:'Marta López',telefono:'+51-1-3456',tipoDocumento:'Pasaporte',documento:'AA123456'}], checkIn:{tarifaId:2,tarifaValue:80,nights:4,startDate:'2024-10-08',endDate:'2024-10-12',total:320} },
